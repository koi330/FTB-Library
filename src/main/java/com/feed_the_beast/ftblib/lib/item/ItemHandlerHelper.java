...
public class ItemHandlerHelper {
    ...
    /**
     * A relaxed version of canItemStacksStack that stacks itemstacks with different
     * metadata if they don't have subtypes.
    ...
    /**
     * Inserts the ItemStack into the inventory, filling up already present stacks
     * first.
     * This is equivalent to the behaviour of a player picking up an item.
     * Note: This function stacks items without subtypes with different metadata
     * together.
     */
     ...
     * output for how "full" the inventory is.
