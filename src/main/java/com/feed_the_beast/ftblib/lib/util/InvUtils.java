...
import com.feed_the_beast.ftblib.lib.item.IItemHandler;
import com.feed_the_beast.ftblib.lib.item.IItemHandlerModifiable;
import com.feed_the_beast.ftblib.lib.item.ItemHandlerHelper;
...
public class InvUtils {
	...
	public static void dropItem(World w, double x, double y, double z, ItemStack item, int delay) {
		dropItem(w, x, y, z, w.rand.nextGaussian() * 0.07F, w.rand.nextFloat() * 0.05F, w.rand.nextGaussian() * 0.07F,
				item, delay);
	}
