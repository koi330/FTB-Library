...
public enum EnumTeamColor implements IStringSerializable {
	...
	public static final NameMap<EnumTeamColor> NAME_MAP = NameMap.createWithNameAndColor(BLUE,
			(sender, value) -> new ChatComponentTranslation(value.getLangKey()), EnumTeamColor::getColor, values());
